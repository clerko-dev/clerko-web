...
export default function Signup() {
  ...
  const onSubmit = async (e) => {
    ...
    else navigate('/dashboard'); // lub pokaż komunikat o weryfikacji email, jeśli ją włączysz
  };

  return (
    <>
      <SEO title="Create account — Clerko" description="Create your Clerko account." />
