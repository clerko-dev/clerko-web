export default function HeroSection() {
  return (
    <section id="hero" className="relative min-h-[100svh] overflow-hidden flex items-center" data-reveal>
      {/* glows */}
        ...
        <div className="space-y-6">
          ...
          <h1 className="text-4xl font-semibold leading-tight tracking-tight sm:text-5xl">
            ...
            <span className="block bg-clip-text text-transparent bg-gradient-to-r from-white via-white to-white/70">
              with{" "}
              <span className="font-brand font-extrabold drop-shadow-[0_1px_8px_rgba(0,0,0,0.35)]" style={{ color: "var(--brand)" }}>
                Clerko
              </span>
            </span>
          </h1>
          ...
          <p className="max-w-xl text-base text-white/70">
            Generate client-ready proposals in under 60 seconds. Templates, pricing blocks, AI assist, e-sign & sending — all in one clean workflow.
          </p>

          <div className="flex flex-wrap items-center gap-3">
            <a href="#generator" className="inline-flex items-center justify-center rounded-xl bg-white px-5 py-3 text-sm font-medium text-slate-900 shadow/50 shadow-black/20 transition hover:shadow-lg hover:opacity-95">
              Try free
            </a>
            <a href="/store" className="inline-flex items-center justify-center rounded-xl border border-white/15 bg-white/5 px-5 py-3 text-sm font-medium text-white/90 backdrop-blur transition hover:bg-white/10">
              View pricing
            </a>
            {/* (to było “pole” pod przyciskami – zostawiamy, można usunąć jeśli chcesz) */}
          ...
          <div className="mt-2 flex items-center gap-4">
            <div className="flex -space-x-2">
              ...
              <span className="inline-block h-8 w-8 rounded-full border border-white/20 bg-white/10 backdrop-blur" />
              <span className="inline-block h-8 w-8 rounded-full border border-white/20 bg-white/10 backdrop-blur" />
              <span className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-white/20 bg-white/10 text-[10px] text-white/70 backdrop-blur">+1k</span>
            </div>
            <p className="text-xs text-white/60">Freelancers, studios & SMBs — avg. rating <span className="text-white/90">4.9/5</span></p>
          </div>
        ...
        <div className="relative">
          <div className="mx-auto w-full max-w-xl rounded-2xl border border-white/10 bg-white/[0.04] p-4 shadow-2xl shadow-black/30 backdrop-blur">
            <div className="mb-3 flex items-center gap-2">
              ...
              <div className="ml-auto rounded-md border border-white/10 bg-white/5 px-2 py-0.5 text-[10px] text-white/60">Proposal.pdf</div>
            </div>
              ...
              <div className="rounded-xl border border-white/10 bg-white/5 p-4">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="text-right">
                    ...
                    <div className="h-7 w-28 rounded-lg" style={{ backgroundColor: "var(--brand)" }} />
                  </div>
                </div>
              </div>
