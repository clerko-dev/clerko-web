  ...
  return (
    <section className="relative py-20 sm:py-24">
      <div className="max-w-6xl mx-auto px-4">
        <motion.h2
          {...fadeUp(0)}
          className="text-2xl sm:text-3xl font-semibold tracking-tight text-center mb-8"
        >
          ...
          {[
            {
              ...
              n: "Amelia Lopez",
              r: "Agency Owner",
              q: "Clerko cut our proposal time from hours to minutes. Clients love the clarity.",
            },
            {
              i: "DK",
              n: "Daniel Kim",
              r: "Freelance Dev",
              q: "The pricing table and PDF export are flawless. I win more small gigs now.",
            },
            {
              i: "SM",
              n: "Sara Malik",
              r: "Consultant",
              q: "Snippets + AI polish = consistent quality without the grind. Worth it.",
            },
          ].map((t, idx) => (
            <motion.figure
              key={t.n}
